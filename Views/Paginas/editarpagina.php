      ...
      <div class="app-title">
        <div>
            ...
            <?php if($_SESSION['permisosMod']['w']){ ?>
                <a href="<?= base_url() ?>/paginas/crear" class="btn btn-danger" ><i class="fas fa-plus-circle"></i> Crear página</a>
            <?php } ?> 
                ...
                <form id="formPaginas" name="formPaginas" class="form-horizontal">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="row">
                           <div class="form-group col-md-12">
                               <button id="btnActionForm" class="btn btn-danger btn-lg btn-block" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i><span id="btnText">Guardar</span></button>
                           </div> 
                        </div>  
                    </div>
                  </div>
