				...
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					...
					?>
						<div>
							...
							<h10>Asegurate que la dirección de envío sea la correcta</h10>
							<br> 	<br>
							...
							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Departamento y Municipio">
							</div>

							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="observación">
							</div>
							<h10>Completa los datos para proceder con el envío</h10>
						...
						<div class="tab-content" id="myTabContent">
						  ...
						  <div class="tab-pane fade" id="registro" role="tabpanel" aria-labelledby="profile-tab">
						  	...
						  	<form id="formRegister"> 
								...
								<button type="submit" class="btn btn-danger">Regístrate</button>
						 	</form>
						  </div>
						</div>
						...
						<div id="optMetodoPago" class="notblock">	
							...
							<div class="divmetodpago">
								...
								<div id="divtipopago" class="notblock" >
									<label for="listtipopago">Elige el tipo de pago que deseas</label>
								...
								<div id="divpaypal">
									<div>
										<p>Los productos son enviados por medio de Cargo expreso</p>
									</div>
									<br>
