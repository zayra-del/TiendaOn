...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "Pedidos <small>Sakura Shop</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - Sakura Shop";
		$data['page_title'] = "Pedido <small>Sakura Shop</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - Sakura Shop";
